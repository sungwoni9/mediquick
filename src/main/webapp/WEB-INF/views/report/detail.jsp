...
<div id="recode">
    ...
    <div id="wrap">
        <div class="grid">
            ...
            <div class="grid-item"><p class="label">의사 처방</p><textarea class="value" id="order-description">작성 내역이 비어있습니다.</textarea></div>
            <div class="grid-item"><p class="label">참고할 과거 검사</p><textarea class="value" id="past-exam-reference">작성 내역이 비어있습니다.</textarea></div>
            ...
            <div class="grid-item"><p class="label">추가적인 소견</p><textarea class="value" id="additional-comments">작성 내역이 비어있습니다.</textarea></div>
